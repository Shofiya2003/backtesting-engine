...
from performance import calculate_total_return, calculate_annualized_return, calculate_annualized_volatility, calculate_sharpe_ratio


class Backtester:
    """for backtesting trading strategies"""

    def __init__(self, initial_capital: float=10000.0, commission_rate: float=0.0001):
